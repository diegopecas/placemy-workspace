...
export const routes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        './features/auth/pages/select-establecimiento/select-establecimiento.component'
      ).then((m) => m.SelectEstablecimientoComponent),
  ...
  },
  {
    ...
    canActivate: [establecimientoGuard],
    loadChildren: () =>
      import('./features/mesero/mesero.routes').then((m) => m.MESERO_ROUTES),
  },
  {
    path: '**',
    redirectTo: '/login',
